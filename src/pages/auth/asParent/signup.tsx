...
const Signup = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      phoneNo: Yup.string().min(8,'Minimum 8 digits are required'),
    ...
    onSubmit: async (values: any) => {
      ...
      if (!withPhone) {
        ...
        body = {
          ...
          countryISOCode: values.countryName,
        };
      }
      setIsLoading(true);
      ...
      try {
        ...
        if (response?.statusCode === 200) {
          if (withPhone) {
            navigate("/auth/as-parent/signup-otp-verify-phone", {
              state: {
            ...
            navigate("/auth/as-parent/signup-otp-verify-email", {
          ...
          <div className="inner hd_5">
            ...
            <CustomTabPanel value={value} index={0}>
              ...
              <form onSubmit={formik.handleSubmit} className="form">
                ...
                <div className="form_btn">
                  <Button
                    // onClick={() => navigate('/auth/as-parent/signup-otp-verify-phone')}
                    type="submit"
            ...
            <CustomTabPanel value={value} index={1}>
              ...
              <form onSubmit={formik.handleSubmit} className="form">
                ...
                <div className="form_btn">
                  <Button
                    // onClick={() => navigate('/auth/as-parent/signup-otp-verify-email')}
                    type="submit"
              ...
              <p>
                ...
                <strong>
                  <a
                    className="c_black"
                    onClick={() =>
                      navigate("/parent/terms-and-conditions", {
                        state: "loginP",
                      })
                    }
                  >
