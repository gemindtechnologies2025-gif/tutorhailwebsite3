...
import { useLazyGetBankQuery, usePostBankMutation, useUpdateBankMutation } from '../../../../service/tutorProfileSetup';
...
//            console.log("body for bank", body);
            ...
            try {
                setIsLoading(true)
                const response = await postBank(body).unwrap();
        ...
        <main className="content">
            ...
            <section className="tutor_setup">
                <div className="conta_iner">
                    ...
                    <div className="rt_s">
                        <h2>
                            <button className="back_arrow" onClick={() => navigate("/auth/as-tutor/profile-setup/step1/1",{replace: true})}>
                        ...
                        <form onSubmit={formik.handleSubmit} className="form">
                            ...
                            <div className="form_btn">
                                <Button variant="outlined" color="primary" onClick={() => navigate('/auth/as-tutor/profile-setup/step1/1',{replace: true})}>Cancel</Button>
                                <Button
...
export default TutorBankDetail;