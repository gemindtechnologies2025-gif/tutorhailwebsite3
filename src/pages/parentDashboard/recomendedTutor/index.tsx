...
import { GRADE_TYPE, GRADE_TYPE_NAME, TEACHING_WRITTEN, TeachingLanguage, TUTOR_TYPE } from "../../../constants/enums";
...
export default function ParentPopularTutor() {
  ...
  // const { filters, value, time, selectedSubjects } = useFilters();
  ...
  const { data, isSuccess, isLoading, isFetching, refetch } = useGetAllTypeTutorQuery({
    page: page,
    limit: 12,
  ...
  const renderWithCount = (selected: string[], mapper: (val: string) => string, placeholder: string) => {
                ...
                <div className="rt_s">
                  ...
                  <ul className="cstmm_tabs cstmmm_tabs_1">
                    ...
                    <li>
                      ...
                      >
                        {Object.entries(TEACHING_WRITTEN).map(([key, value]) => (
                    ...
                    <li>
                      ...
                      >
                        ...
                        <MenuItem value={TeachingLanguage.BOTH} >
                          Both
                        </MenuItem>
                    ...
                    <li>
                      <Select
                        ...
                        displayEmpty
                        renderValue={(selected) =>
                          renderWithCount(selected, (s) => GRADE_TYPE_NAME[+s], "Class")
                        }
                  ...
                  <div className="tutoer_list gap_m">
                    {data1?.length ? (
                      ...
                      isLoading ?
                        <div style={{ textAlign: 'center' }}> <CircularProgress size={40} /></div> :
